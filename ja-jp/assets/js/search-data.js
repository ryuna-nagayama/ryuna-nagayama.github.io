...
const siteUrl = "https://ryuna-nagayama.github.io"; 
let updatedUrl = currentUrl.replace("https://ryuna-nagayama.github.io", "");
...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/ja-jp/";
          ...
          title: "履歴書",
          description: "最終更新は2026年6月16日です。 PDF版には隣のアイコンからアクセスできます。",
          section: "Navigation menu",
          handler: () => {
          ...
          section: "Navigation menu",
          handler: () => {
            window.location.href = "/ja-jp/talks/";
          },
        ...
        handler: () => {
          ...
          description: "",
          section: "",handler: () => {
              window.location.href = "/ja-jp/books/pt-br/the_godfather/";
            },},{id: "news-webサイトを公開しました",
          title: 'Webサイトを公開しました！',
          description: "",
          section: "News",},{id: "news-leuven-school-basics-of-nonequilibrium-statistical-mechanics-に参加しています",
          title: 'Leuven school: Basics of nonequilibrium statistical mechanics に参加しています。',
          description: "",
          ...
          description: "",
          section: "News",},{id: "news-共同研究の論文-geometric-decomposition-of-information-flow-new-insights-into-information-thermodynamics-がphysical-review-research誌に掲載されました",
          title: '共同研究の論文 “Geometric decomposition of information flow: New insights into information thermodynamics” がPhysical Review...',
          description: "",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/ja-jp/projects/en-us/2_project/";
            },},{id: "projects-project-3-with-very-long-name",
          title: 'project 3 with very long name',
          description: "a project that redirects to another website",
          section: "Projects",handler: () => {
              window.location.href = "/ja-jp/projects/en-us/3_project/";
            },},{id: "projects-project-4",
          title: 'project 4',
          description: "another without an image",
          section: "Projects",handler: () => {
              window.location.href = "/ja-jp/projects/en-us/4_project/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/ja-jp/projects/en-us/6_project/";
            },},{
        id: 'social-email',
        title: 'Send an email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%72%79%75%6E%61.%6E%61%67%61%79%61%6D%61@%75%62%69.%73.%75-%74%6F%6B%79%6F.%61%63.%6A%70", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0002-0733-2740", "_blank");
        },
      },{
        id: 'social-scholar',
