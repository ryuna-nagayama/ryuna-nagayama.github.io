...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "cv",
          description: "updated Jul. 16, 2026. Click the right icon for pdf version.",
          section: "Navigation menu",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "",handler: () => {
            ...
            },},{id: "news-i-have-launched-my-personal-academic-website",
          title: 'I have launched my personal academic website.',
          description: "",
